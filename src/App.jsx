...
import PaginaLandingLeadOptimized from './pages/PaginaLandingLeadOptimized.jsx';
  ...
  return (
    <AnimatePresence mode="wait" initial={false}>
      <Routes location={location} key={location.pathname}>
        <Route path="/" element={<PageTransition><PaginaLandingLeadOptimized /></PageTransition>} />
